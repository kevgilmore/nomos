...
function printHelp() {
  console.log("Usage: nomos dev [-d <app>] | nomos stop | nomos deploy");
...
async function deployCommand() {
  ...
  execFileSync(firebaseCommand, ["deploy", "--only", "hosting:id,hosting:home,hosting:fitness,functions"], { cwd: repoRoot, stdio: "inherit", env: { ...process.env, NEXT_PUBLIC_NOMOS_ENV: "production" } });
}
