...
const outputDirectory = path.join(destination, "out");
...
execFileSync(firebaseCommand, ["deploy", "--only", `hosting:${slug}`, "--project", "nomos-2aafe"], { cwd: repoRoot, stdio: "inherit" });
try {
