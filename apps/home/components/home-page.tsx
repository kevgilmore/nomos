...
export function HomePage() {
  ...
  const apps = useMemo(() => {
    return NOMOS_APPS.filter((app) => app.label.toLowerCase().includes(query.trim().toLowerCase())).slice(0, 5);
  }, [query]);
